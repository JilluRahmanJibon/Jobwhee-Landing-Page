...
const footer = () => {
  return (
    ...
    >
      <div className="[@media(min-width:1210px)]:w-[1200px] w-[95%]  [@media(min-width:1050px)]:px-[5.5rem] px-[3.5rem] mx-auto bg-white [@media(min-width:866px)]:rounded-[50px] [@media(min-width:440px)]:rounded-[40px] rounded-[30px] relative">
