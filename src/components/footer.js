            ...
            <div className="w-full flex [@media(min-width:1135px)]:flex-row flex-col justify-center">
              ...
              <label className="[@media(min-width:600px)]:w-auto w-[90%] relative flex items-center [@media(min-width:1135px)]:mx-0 mx-auto">
                ...
                <div className="absolute [@media(min-width:440px)]:left-[6px] left-[4px] top-0 flex items-center h-full">
                  <div className="bg-gradient-to-r from-[#A5EC5E] to-[#BDC502]  [@media(min-width:1450px)]:!w-[50.02px] [@media(min-width:440px)]:w-[38px] w-[36px] [@media(min-width:1450px)]:!h-[50.02px]  [@media(min-width:440px)]:h-[38px] h-[36px] flex items-center justify-center rounded-[50%]">
                ...
                <button className="[@media(min-width:1450px)]:!w-[131px] w-auto [@media(min-width:440px)]:px-[20px] px-[15px] [@media(min-width:1450px)]:!h-[60px] [@media(min-width:375px)]:h-[50px] h-[38px] [@media(min-width:1450px)]:!text-[16px] [@media(min-width:375px)]:text-[13px] text-[12px] font-[500] text-[#18470D] border-[3px] border-white bg-[#CBEC5E] rounded-[30px] shadow-[0_15px_40px_5px_#73737333]">
                  Subscribe
                </button>
              </label>
            </div>
            ...
            <div className="[@media(min-width:1450px)]:!w-[240px] [@media(min-width:885px)]:w-[200px] w-full flex-col [@media(min-width:885px)]:justify-start justify-center [@media(min-width:885px)]:mx-0 mx-auto text-center [@media(min-width:885px)]:text-left">
              <a className="flex title-font font-medium items-center [@media(min-width:885px)]:justify-start justify-center text-gray-900">
                ...
                <Image
                  ...
                  width={108}
                  height={17}
                  className="cursor-pointer  [@media(min-width:910px)]:!hidden [@media(min-width:885px)]:flex hidden"
                />
                <Image
                  src="/logo2.png"
                  alt="Logo"
                  width={171}
                  height={20}
                  className="cursor-pointer  [@media(min-width:885px)]:hidden flex"
                />
              </a>
